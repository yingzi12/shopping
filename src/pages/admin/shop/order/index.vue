...
import adminItemCardComponent from "components/order/adminItemCardComponent.vue";
...
async function getList(page: number) {
  try {
    ...
    // 使用 get 方法发送 GET 请求
    const response = await api.get(`/admin/order/page?`+tansParams(queryParams.value));
